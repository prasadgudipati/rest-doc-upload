package org.finratest.archive.dao;
...
public class FileSystemDocumentDao implements IDocumentDao {
    ...
    public static final String META_DATA_FILE_NAME = "File.Metadata";
     ...
     * 
     * @see org.finratest.archive.dao.IDocumentDao#insert(org.finratest.archive.service.Document)
     */
    @Override
     ...
     * the parameter.
     * 
     * @see org.finratest.archive.dao.IDocumentDao#findByPersonNameDate(java.lang.String, java.util.Date)
     */
    @Override
     ...
     * 
     * @see org.finratest.archive.dao.IDocumentDao#load(java.lang.String)
     */
    @Override
    ...
    private void saveFileData(Document document) throws IOException {
    	...
    	LOG.info("### Saving file to path -->"+new File(path));
